...
/* نقاط كلمة اليوم حسب عدد المحاولات، وكل تلميح مدفوع ينزّلك درجة وحدة */
const WORDLE_SCALE = [25, 15, 9, 6, 4, 2];
const WORDLE_PTS = (tries, paid) => WORDLE_SCALE[Math.max(0, Math.min(WORDLE_SCALE.length - 1, (tries || 1) - 1 + (paid || 0)))];
